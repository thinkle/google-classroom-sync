export const GoogleAppsScript = {
  ...
  fetchAspenTeacher(): Promise<Promise<import("../gas/types").User>> {
    return new Promise((resolve, reject) => {
      google.script.run
        .withSuccessHandler((result: Promise<import("../gas/types").User>) =>
          resolve(result)
        )
        .withFailureHandler((error: any) => reject(error))
        .fetchAspenTeacher();
  ...
  getAssessmentConnections(): Promise<{ [key: string]: string }> {
    return new Promise((resolve, reject) => {
      google.script.run
        .withSuccessHandler((result: { [key: string]: string }) =>
          resolve(result)
        )
        .withFailureHandler((error: any) => reject(error))
  ...
  getGradeLog(
    assessmentId: string
  ): Promise<{ timestamp: string; email: string; score: string }[]> {
    return new Promise((resolve, reject) => {
      google.script.run
        .withSuccessHandler(
          (result: { timestamp: string; email: string; score: string }[]) =>
            resolve(result)
        )
        .withFailureHandler((error: any) => reject(error))
  ...
  getRubricAssessmentConnections(): Promise<{
  ...
  fetchAspenCourses(
    teacher: import("/Users/thinkle/Projects/google-classroom-sync/src/gas/types").User
  ): Promise<Promise<import("../gas/types").Course[]>> {
    return new Promise((resolve, reject) => {
      google.script.run
        .withSuccessHandler(
          (result: Promise<import("../gas/types").Course[]>) => resolve(result)
        )
        .withFailureHandler((error: any) => reject(error))
  ...
  fetchLineItems(
    course: import("/Users/thinkle/Projects/google-classroom-sync/src/gas/types").Course
  ): Promise<Promise<import("../gas/types").LineItem[]>> {
    return new Promise((resolve, reject) => {
      google.script.run
        .withSuccessHandler(
          (result: Promise<import("../gas/types").LineItem[]>) =>
            resolve(result)
        )
        .withFailureHandler((error: any) => reject(error))
  ...
  fetchCategories(
    course: any
  ): Promise<Promise<import("../gas/types").Category[]>> {
    return new Promise((resolve, reject) => {
      google.script.run
        .withSuccessHandler(
          (result: Promise<import("../gas/types").Category[]>) =>
            resolve(result)
        )
        .withFailureHandler((error: any) => reject(error))
  ...
  fetchGradingPeriods(): Promise<
    Promise<import("../gas/types").GradingPeriod[]>
  > {
    return new Promise((resolve, reject) => {
      google.script.run
        .withSuccessHandler(
          (result: Promise<import("../gas/types").GradingPeriod[]>) =>
            resolve(result)
        )
        .withFailureHandler((error: any) => reject(error))
        .fetchGradingPeriods();
  ...
  createLineItem(
    id: string,
    lineItemData: import("/Users/thinkle/Projects/google-classroom-sync/src/gas/types").LineItem
  ): Promise<Promise<import("../gas/types").LineItem>> {
    return new Promise((resolve, reject) => {
      google.script.run
        .withSuccessHandler(
          (result: Promise<import("../gas/types").LineItem>) => resolve(result)
        )
        .withFailureHandler((error: any) => reject(error))
  ...
  fetchAspenRoster(
    classId: string
  ): Promise<Promise<import("../gas/types").User[]>> {
    return new Promise((resolve, reject) => {
      google.script.run
        .withSuccessHandler((result: Promise<import("../gas/types").User[]>) =>
          resolve(result)
  ...
  fetchGoogleAssessments(
    courseId: any
  ): Promise<GoogleAppsScript.Classroom.Schema.CourseWork[]> {
    return new Promise((resolve, reject) => {
      google.script.run
        .withSuccessHandler(
          (result: GoogleAppsScript.Classroom.Schema.CourseWork[]) =>
            resolve(result)
        )
        .withFailureHandler((error: any) => reject(error))
  ...
  fetchGoogleGrades(
    courseId: any,
    assessmentId: any
  ): Promise<import("../gas/types").Grade[]> {
    return new Promise((resolve, reject) => {
      google.script.run
        .withSuccessHandler((result: import("../gas/types").Grade[]) =>
          resolve(result)
        )
        .withFailureHandler((error: any) => reject(error))
  ...
  fetchRubric(
    courseId: any,
    assessmentId: any
  ): Promise<import("../gas/types").Rubric> {
    return new Promise((resolve, reject) => {
      google.script.run
        .withSuccessHandler((result: import("../gas/types").Rubric) =>
          resolve(result)
        )
        .withFailureHandler((error: any) => reject(error))
